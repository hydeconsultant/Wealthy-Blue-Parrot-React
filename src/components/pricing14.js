        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text174 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text169 thq-heading-3">
                          $29/mo
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text159 thq-body-large">
                          or $299 yearly
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  <p>
                    {props.plan3 ?? (
                      <Fragment>
                        <p className="pricing14-text200 thq-body-large">
                          Enterprise plan
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text205 thq-heading-3">
                          $299/yr
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  <span>
                    {props.plan31 ?? (
                      <Fragment>
                        <span className="pricing14-text180 thq-body-large">
                          Enterprise plan
                        </span>
                      </Fragment>
                    )}
